...
% 
% * You should complete the tutorial "mrTutMR_01" prior to this one.
...
% are two ways we can adjust the slice width.  One way, is to change the gradient.  A second way, illustrated here, is to
